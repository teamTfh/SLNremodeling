...
for (i in list_ID[1:1])
{
  ...
  prox.results <- cellProximityEnrichment(sln.sm, cluster_column = 'L1.annot', adjust_method = "fdr",
  ...
  plots[i] <- cellProximityBarplot(sln.sm, CPscore = prox.results,  min_orig_ints = 3, min_sim_ints = 3, return_plot = T)
}
